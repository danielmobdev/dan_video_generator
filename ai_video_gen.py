...
# Configure FFmpeg and ImageMagick paths (adjust these based on your system)
change_settings({
...
# Configuration
config = {
    'GEMINI_API_KEY': 'AIzaSyDYU85enZKoPqAJVF3hlcySstAqhqg-tQE',  # Replace with your own key
    'VIDEO_SIZE': (1080, 1920),  # 9:16 ratio
    ...
    'FONT_PATH': "fonts/BebasNeue-Regular.ttf",  # Ensure this font exists
    'TEXT_STYLE': {
        'font_size': 90,
        'text_color': '#FFD700',
        'stroke_color': '#000000',
...
class YouTubeVideoCreator:
    ...
    def _craft_dynamic_prompt(self, category, topic, keywords):
        ...
        # Enhanced negative prompt to exclude humans and faces
        ...
        # Combine into final prompt with explicit no-humans clause
    ...
    def _get_image(self, category, topic, keywords):
        ...
        try:
            ...
            # Generate image at 9:16 aspect ratio, divisible by 8
            image = self.image_gen(
                prompt=prompt,
                negative_prompt=negative_prompt,
                height=960,  # Divisible by 8 (120)
                width=544,   # Divisible by 8 (68), close to 9:16
            ...
            # Resize to exact 9:16 (1080x1920) without stretching
    ...
    def generate_script(self, topic):
        ...
        Strictly exclude any human elements, faces, or people from narration and keywords; focus on objects, concepts, or scenes that can be depicted realistically without humans.
        Format:
    ...
    def create_video(self, category, topic, output_file="youtube_short.mp4"):
        ...
        for idx, scene in enumerate(self.scenes):
            ...
            try:
                ...
                if idx == 0:
                    clips.append(composite)  # No fade-in for the first scene
                else:
...
if __name__ == "__main__":
    print("Available categories: Photorealistic, Stylized, Design, General (Artistic), Cyberpunk, Fantasy, Horror, Anime, Science Fiction, Steampunk, Pixel Art")
